defmodule AdminSiteDemoWeb.Router do
  ...
  import AdminSiteDemoWeb.UserAuth
  ...
  scope "/", AdminSiteDemoWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{AdminSiteDemoWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", AdminSiteDemoWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{AdminSiteDemoWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", AdminSiteDemoWeb do
    ...
    live_session :current_user,
      on_mount: [{AdminSiteDemoWeb.UserAuth, :mount_current_user}] do
