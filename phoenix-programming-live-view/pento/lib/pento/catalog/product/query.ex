defmodule Pento.Catalog.Product.Query do
  ...
  def apply_gender_filter(query, "all") do
    query # we don't need to modify the query for all
  end

  def apply_gender_filter(query, gender) do
    query
  ...
  @doc """
  Get all products rated by user
  """
