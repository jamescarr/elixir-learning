defmodule PentoWeb.UserLiveTest do
  ...
  @create_attrs %{username: "some username", email: "some email", hashed_password: "some hashed_password", confirmed_at: "2024-07-30T19:29:00Z"}
  @update_attrs %{username: "some updated username", email: "some updated email", hashed_password: "some updated hashed_password", confirmed_at: "2024-07-31T19:29:00Z"}
