defmodule AshDemo.Accounts.User do
  ...
  authentication do
    tokens do
      ...
      signing_secret AshDemo.Secrets
    end
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender AshDemo.Accounts.User.Senders.SendPasswordResetEmail
        end
      end
    end
    ...
    add_ons do
      confirmation :confirm_new_user do
        ...
        sender AshDemo.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end
  end
